  ...
  <div class="fb-home-body">
    ...
    <div class="fb-home-timeline-area">
      <div class="fb-home-timeline">
        ...
        <!-- User Post  -->
        <div class="user-post" id="show_post">
        ...
        <?php foreach ($datas as $post): ?>
          <div class="user-post">
            <div class="user-post-header">
              <div class="post-info">
                <img src="./media/photo/<?php echo $post->photo; ?>" alt="" />
                <div class="user-details">
                  <a class="author" href="#"><?php echo $post->name; ?></a>
                  <span><?php echo $post->createdAt; ?>
                    <svg
                      fill="currentColor"
                      viewBox="0 0 16 16"
                      width="1em"
            ...
            <div class="post-media">
              ...
              $photos = json_decode($post->post_photo);

              // Check if there are photos or a video
              if (!empty($photos)) {
                $photoCount = count($photos); // Get the number of photos
              ?>
                <div class="photo-grid photos-<?php echo $photoCount; ?>">
                  <?php foreach ($photos as $photo): ?>
                    <div class="photo-item">
                      <img src="media/posts/<?php echo htmlspecialchars($photo); ?>" alt="Post Photo" />
                    </div>
                  <?php endforeach; ?>
                </div>
              <?php } elseif (!empty($post->post_video)) { ?>
                <div class="video-container">
                  <video controls>
                    <source src="media/videos/<?php echo htmlspecialchars($post->post_video); ?>">
                  </video>
                </div>
              <?php } else { ?>
            ...
            <div class="post-comments">
              <div class="comments-header">
                <div class="reaction">
                  ...
                  <a id="like" href="#"><?php echo $post->likes; ?> Likes</a>
                </div>
                <div class="counts">
